                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              _orderInfoChip(Icons.category,
                                  '${o.orderType} • ${o.category}'),
                              const Spacer(),
                              _orderInfoChip(Icons.scale,
                                  '${o.quantity} ${o.quantityUnit}'),
                            ],
                          ),
                          if (o.notes.isNotEmpty ||
                              o.adminNotes.isNotEmpty) ...[
                          ...
                          Row(
                            children: [
                              ...
                              PopupMenuButton<String>(
                                ...
                                onSelected: (v) {
                                  if (v == 'message') {
                                    _AdminActions.showMessageDialog(
                                        context, db, o.buyerId, o.buyerName);
                                  } else if (v == 'notes') {
                                    _AdminActions._showAdminNotesDialog(
                                        context, db, o);
                                  } else {
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (_) =>
                                            BulkFulfillmentScreen(order: o)),
                                  );
                                },
                                icon: const Icon(Icons.call_split),
                                label: const Text(
                                    'Fulfill (Request from Farmers)'),
...
class _AdminActions {
  static void _showAdminNotesDialog(
      BuildContext context, DatabaseService db, BulkOrderModel order) {
