...
class _BulkOrderFormScreenState extends State<BulkOrderFormScreen> {
  ...
  final List<String> _inputCategories = [
    'Fertilizers', 'Seeds', 'Pesticides & Insecticides', 'Farm Equipment', 'Other'
  ];
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text('Your bulk order has been securely sent to the Registry. Our distributor network will process it shortly.'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.pop(ctx);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Place Bulk / Special Order', style: TextStyle(color: AppTheme.textPrimary, fontSize: 18)),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    Icon(Icons.assignment_turned_in, color: AppTheme.green, size: 32),
              ...
              Text('Order Type', style: TextStyle(color: AppTheme.textPrimary, fontSize: 14, fontWeight: FontWeight.w600)),
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isProduce ? AppTheme.greenSurface : AppTheme.surfaceLight,
                          border: Border.all(color: isProduce ? AppTheme.green : AppTheme.border),
                        ...
                        child: Center(
                          child: Text(
                            'Produce',
                            style: TextStyle(
                              color: isProduce ? AppTheme.greenDark : AppTheme.textSecondary,
                              fontWeight: isProduce ? FontWeight.w600 : FontWeight.w500,
                            ),
                          ),
                        ),
                      ),
              ...
              CustomTextField(
                ...
                hint: isProduce ? 'e.g. Red Beauty Groundnuts' : 'e.g. NPK 17-17-17 Fertilizer',
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: CustomDropdown(
                      label: 'Unit',
                      value: _unit,
                      items: const ['Kg', 'Tonnes', 'Bags', 'Litres', 'Pieces'],
              ...
              CustomTextField(
                ...
                hint: 'Any specific instructions for delivery, packaging, or brand preferences?',
